...
//----
   ...
   ObjectSet("Pivot_Line", OBJPROP_COLOR, indicator_color1);
   ...
   ObjectSet("R0.5_Line", OBJPROP_COLOR, indicator_color3);
   ...
   ObjectSet("R1.0_Line", OBJPROP_COLOR, indicator_color3);
   ...
   ObjectSet("R1.5_Line", OBJPROP_COLOR, indicator_color3);
   ...
   ObjectSet("R2.0_Line", OBJPROP_COLOR, indicator_color3);
   ...
   ObjectSet("R2.5_Line", OBJPROP_COLOR, indicator_color3);
   ...
   ObjectSet("R3.0_Line", OBJPROP_COLOR, indicator_color3);
   ...
   ObjectSet("S0.5_Line", OBJPROP_COLOR, indicator_color2);
   ...
   ObjectSet("S1.0_Line", OBJPROP_COLOR, indicator_color2);
   ...
   ObjectSet("S1.5_Line", OBJPROP_COLOR, indicator_color2);
   ...
   ObjectSet("S2.0_Line", OBJPROP_COLOR, indicator_color2);
   ...
   ObjectSet("S2.5_Line", OBJPROP_COLOR, indicator_color2);
   ...
   ObjectSet("S3.0_Line", OBJPROP_COLOR, indicator_color2);
